...
for testcase in x_test_instance:
    ...
    response_2 = client_2.chat.completions.create(
            model=MODEL_2,
            messages = [{"role":"system","content":system_message}] + [{"role": "user","content":f"You have ample time to think. Adhere to the above principles, please give your evaluation of this student's {testcase} judgment {response_glm_4_max}. Let's work this out in a step by step way to be sure we have the right answer."}],
            stream = False,
            temperature=0,
        )
    ...
    response_final = response_3.choices[0].message.content
