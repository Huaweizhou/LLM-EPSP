...
# 将抽样结果保存到新的CSV文件（可选）
sampled_df.to_csv('dataset\dadaset_OULAD\studentInfo_AAA_test.csv', index=False)
remaining_df.to_csv('dataset\dadaset_OULAD\studentInfo_AAA_trian.csv', index=False)
